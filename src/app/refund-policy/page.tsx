  ...
  return (
    <main className="min-h-screen bg-[#fbfcff] text-slate-950">
      ...
      <div className="mx-auto max-w-4xl px-5 py-12 sm:px-6 sm:py-16">
        <p className="text-xs font-bold uppercase tracking-[0.16em] text-blue-600">Refund Policy</p>
        ...
        <div className="mt-10 space-y-5">
          <section className={sectionClass}>
            ...
            <p className="mt-3 leading-7 text-slate-600">
              You can also contact <a className="font-semibold text-blue-700 hover:underline" href="mailto:support@pdfbright.app">support@pdfbright.app</a> if you need help identifying a PDFBright transaction or troubleshooting a product issue before requesting a refund.
            </p>
          </section>
          ...
          <section className={sectionClass}>
            ...
            <p className="mt-3 leading-7 text-slate-600">
              If a material technical problem prevents you from using PDFBright Pro as described, contact us first at <a className="font-semibold text-blue-700 hover:underline" href="mailto:support@pdfbright.app">support@pdfbright.app</a>. We will try to resolve the issue promptly and, where appropriate, help you provide the information Paddle needs to review a refund request.
            </p>
          </section>
          ...
          <section className={sectionClass}>
            ...
            <p className="mt-3 leading-7 text-slate-600">
              Questions about PDFBright Pro, billing access, or a transaction can be sent to <a className="font-semibold text-blue-700 hover:underline" href="mailto:support@pdfbright.app">support@pdfbright.app</a>.
            </p>
          </section>
        </div>
